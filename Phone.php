            ...
            <section class="header">
                ...
                <nav class="navbar navbar-expand-sm nav2-color justify-content-center">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item2"><a class="nav-link disabled" href="">Asus</a></li>
                        <li class="nav-item2"><a class="nav-link disabled" href="">Huawie</a></li>
                        <li class="nav-item2"><a class="nav-link disabled" href="">Meizu</a></li>
                        <li class="nav-item2"><a class="nav-link disabled" href="">Google</a></li>
                        <li class="nav-item2"><a class="nav-link disabled" href="">Sony</a></li>
                        <li class="nav-item2"><a class="nav-link disabled" href="">LG</a></li>
                        <li class="nav-item2"><a class="nav-link disabled" href="">Panasonic</a></li>
                        <li class="nav-item2"><a class="nav-link disabled" href="">Honor</a></li>
                        <li class="nav-item2"><a class="nav-link disabled" href="">Motorola</a></li>
                        <li class="nav-item2"><a class="nav-link disabled" href="">HTC</a></li>
                        <li class="nav-item2"><a class="nav-link disabled" href="">Lenovo</a></li>
                    </ul>
                </nav>
            </section>
